...
btn_doctor = Button(root, text="Show the hospital allotted", command=obj1.getDoctor,bg="pink", fg="pink",relief = FLAT)

btn_doctor.place(relx=0.1, rely=0.23,anchor=CENTER)
btn_it = Button(root, text="Show the IT company allotted", command=obj2.getIT,bg="pink", fg="pink",relief = FLAT)

btn_it.place(relx=0.11, rely=0.53,anchor=CENTER)
btn_chemical = Button(root, text="Show the chemical company allotted", command=obj3.getChemical, bg="pink", fg="pink",relief = FLAT)
